...
INSERT INTO todo_lists (id, title, user_id, created_at, updated_at) VALUES
  ...
  ('e4ccaf55-5c4d-4af4-ff4f-4ff9fa704e55', 'Personal Goals', 'a0eebc99-9c0b-4ef8-bb6d-6bb9bd380a11', NOW(), NOW()),
  
  -- Bob's lists
  ('f5ddab44-4d5e-4ba5-aa5a-5aa0ab815f66', 'Shopping List', 'b1ffdc88-8b1a-4de7-cc5c-5cc8cd481b22', NOW(), NOW()),
  ('a6eeab33-3e6f-4cb6-bb6b-6bb1ab926a77', 'Fitness Routine', 'b1ffdc88-8b1a-4de7-cc5c-5cc8cd481b22', NOW(), NOW())
...
INSERT INTO todo_items (id, title, description, is_completed, list_id, user_id, start_date, deadline_date, created_at, updated_at) VALUES
  ...
  ('77777777-7777-7777-7777-777777777777', 'Read 2 books this month', 'Currently reading Clean Architecture by Robert Martin', false, 'e4ccaf55-5c4d-4af4-ff4f-4ff9fa704e55', 'a0eebc99-9c0b-4ef8-bb6d-6bb9bd380a11', NOW(), NOW() + INTERVAL '30 days', NOW(), NOW()),
  
  -- Shopping List items (Bob)
  ('88888888-8888-8888-8888-888888888888', 'Buy new running shoes', 'Size 10, prefer Nike or Adidas', false, 'f5ddab44-4d5e-4ba5-aa5a-5aa0ab815f66', 'b1ffdc88-8b1a-4de7-cc5c-5cc8cd481b22', NULL, NULL, NOW(), NOW()),
  ('99999999-9999-9999-9999-999999999999', 'Get birthday gift for Mom', 'Her birthday is next week!', false, 'f5ddab44-4d5e-4ba5-aa5a-5aa0ab815f66', 'b1ffdc88-8b1a-4de7-cc5c-5cc8cd481b22', NULL, NOW() + INTERVAL '7 days', NOW(), NOW()),
  
  -- Fitness Routine items (Bob)
  ('aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa', 'Morning run - 5km', 'Start week with good energy', true, 'a6eeab33-3e6f-4cb6-bb6b-6bb1ab926a77', 'b1ffdc88-8b1a-4de7-cc5c-5cc8cd481b22', NOW() - INTERVAL '1 day', NOW() - INTERVAL '1 day', NOW(), NOW()),
  ('bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb', 'Gym session - Upper body', 'Focus on chest and arms', false, 'a6eeab33-3e6f-4cb6-bb6b-6bb1ab926a77', 'b1ffdc88-8b1a-4de7-cc5c-5cc8cd481b22', NOW(), NOW(), NOW(), NOW()),
  ('cccccccc-cccc-cccc-cccc-cccccccccccc', 'Yoga class', 'Wednesday evening at 7 PM', false, 'a6eeab33-3e6f-4cb6-bb6b-6bb1ab926a77', 'b1ffdc88-8b1a-4de7-cc5c-5cc8cd481b22', NOW() + INTERVAL '2 days', NOW() + INTERVAL '2 days', NOW(), NOW())
ON CONFLICT (id) DO NOTHING;
